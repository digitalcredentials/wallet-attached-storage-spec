...
Example request (note the trailing slash), no `id` specified:
...
Example request (note the trailing slash), an `id` specified:
...
| Reserved API Endpoint                                | Reserved segment | Purpose                              |
|------------------------------------------------------|------------------|--------------------------------------|
| `/space/{space_id}/{collection_id}/:resourceId/meta` | `meta`           | User-defined metadata for a resource |
